...
const Sidebar = () => {
    return (
        <aside className='flex flex-col h-full w-1/4 justify-start items-center bg-[#022D57] py-5'>
            ...
            <div className="flex flex-col h-full w-full justify-start gap-4 items-start py-5">
                ...
                <div className='flex flex-row w-full justify-center gap-20 items-center'>
                    <div className='h-6 w-1 bg-gray-500'></div>
                    <h1>Reseach</h1>
                </div>
                <ul className='flex flex-col gap-2 w-full font-medium text-lg'>
                    <li className='w-full'>
