    ...
    return (
        <nav className='bg-lime-600 h-20 w-full flex flex-row justify-between items-center px-5 m-5 rounded-xl'>
            ...
            <div className="flex flex-1 flex-row gap-3 justify-end items-end">
                <button className='flex justify-center items-center h-10 w-10 rounded-xl border-[1px] border-[#DDDDDD] hover:border-black hover:text-black'>
                    <FaRegBell />
                </button>
                <button className='flex justify-center items-center h-10 w-10 rounded-xl border-[1px] border-[#DDDDDD] hover:border-black hover:text-black'>
                    <FaRegEnvelopeOpen />
                </button>
                <button className='flex justify-center items-center h-10 w-10 rounded-xl border-[1px] border-[#DDDDDD] text-yellow-400 hover:border-black hover:text-yellow-600'>
                    <FaSun />
                    {/* <FaMoon /> */}
                </button>
