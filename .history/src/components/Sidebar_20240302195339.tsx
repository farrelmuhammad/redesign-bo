...
const Sidebar = () => {
    return (
        <aside className='flex flex-col h-full w-1/4 justify-start items-center bg-[#022D57] py-5'>
            ...
            <div className="flex flex-col h-full w-full justify-start gap-4 items-start py-5 px-10">
                <ul className='flex flex-col gap-2 w-full font-medium text-lg'>
                    <li className='w-full'>
                        <button className='flex flex-row justify-start w-full items-center gap-4 py-5 px-2 hover:rounded-xl hover:bg-[#3996DC] hover:bg-opacity-[20%] hover:'>
                        <FaHome /> Dashboard
                        </button>
                    </li>
